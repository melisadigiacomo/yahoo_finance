...
ax = df.plot(x = "Date", y = 'Close',title ="S&P500 Index", fontsize=15, legend = False)
ax.set_xlabel("Date",fontsize=15)
ax.set_ylabel("Price",fontsize=15)
ax.annotate('COVID-19', xy=(914, 3450), xytext=(940, 3600),fontsize=15,
            arrowprops=dict(facecolor='black', shrink=0.05))
ax.annotate("America's trade war with China", xy=(600, 2796), xytext=(630, 3100), fontsize=15,
            arrowprops=dict(facecolor='black', shrink=0.05))
plt.show()
